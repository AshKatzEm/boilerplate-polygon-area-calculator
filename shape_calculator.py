class Rectangle:
    ...
    def set_width(self, width):
        """self.set_width() sets the `width` attribute value of the Rectangle object."""
        self.width = width

    def set_height(self, height):
        """self.set_height() sets the `height` attribute value of the rectangle object."""
        self.height = height
    ...
    def get_amount_inside(self, shape):
        """self.get_amount_inside(shape) takes another shape (square or rectangle) as an argument and returns the whole number of times that shape could fit inside self (with no rotations), self.area // shape.area ."""
